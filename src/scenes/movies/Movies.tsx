...
import { RecomendedSection, VideosTitle, VideosList, VideosItem, RecomendedVideo, VIdeoCard, VideoBookMark, PLayBtn, VideoInfo, VideoYear, Dot, VideoCategory, VideoRating, MovieName, SearchBar, SearchInput, SearchLogo, Main } from '../Home/styles/homeStyles'
import data from '../../data'
import Search from '../../assets/icon-search.svg'
import AppContext from '../../context/AppContext'
function Movies() {
    const {setTrendingMovies,trendingMovies} = useContext(AppContext)
  ...
  return (
   ...
   <RecomendedSection>
    {searchQuery.length === 0 ? (<VideosTitle>Movies</VideosTitle> ):
